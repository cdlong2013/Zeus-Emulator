...
namespace Plus.Communication.Packets.Incoming.Catalog
{
    internal class CheckGnomeNameEvent : IPacketEvent
    {
        public void Parse(GameClient session, ClientPacket packet)
        {
           ...
           //  room.GetRoomUserManager().DeployBot(new RoomBot(pet.PetId, pet.RoomId, "pet", "freeroam", pet.Name, "", pet.Look, x, y, 0, 0, 0, 0, 0, 0, ref rndSpeechList, "", 0, pet.OwnerId, false, 0, false, 30, 1, 100));
            //Give the food.
