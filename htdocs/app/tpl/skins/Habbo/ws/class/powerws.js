window.onload = function() {
	 $.get("/ws/static/ws", function(data) {
        document.getElementById("app").innerHTML = (data);
    });
	var RP = '54.36.30.107';
	var RPurl = 'http://habborp.net';
	var Port = '2011';
	var host = "ws://"+ RP +":"+ Port +"/";
    var ws = new WebSocket(host);
	var username = document.getElementById("myname").innerHTML;
    var look = 'https://www.habbo.nl/habbo-imaging/avatarimage?figure=';       
    var bleeding = false;
    var lock = false;
    var isbot = false;
    var wl = false;
    ...
    function connect() {
        ...
        ws.onclose = function() {
            ...
            window.location.replace("http://habborp.net/disconnect");
    ...
    $('div').mouseover(function(e) {
		...
		$("#trade_button2").css("background", "#a8615b");
            ...
            $('#gangicon').css('left', 131);
            $('#gangicon').css('bottom', 13);
